...
#
from h2a.helpers import get, get_cell, to_num
...
def get_nonenergy_material_price_for_year(
    ...
    return (
        INFLATION_FACTOR
        * to_num(get(nonenergy_material, "usage"))
        * (
            get_cell(
                non_energy_material_prices, get(nonenergy_material, "name"), "Price"
            )
