...
#
import::from("inputs.R", plant_design_capacity, capacity_factor, inflation_rate, startup_year, ref_year, construct, anal_period, CurrentYear, BasisYear, .directory = here(h2a))
import::from("ref_tables.R", get_plant_cost_index, get_cpi, .directory = here(h2a))
