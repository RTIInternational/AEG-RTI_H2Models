...
get_feedstock_costs <- function(years, prices, inflation_price_increase_factors, start_time, plant_output_kg_per_year, percnt_var) {
    ...
    return(lapply(years, prices, inflation_price_increase_factors, function(year, price, inflation_price_increase_factor) calculate_feedstock_cost_for_year(year, price, inflation_price_increase_factor, start_time, plant_output_kg_per_year, percnt_var)))
}
